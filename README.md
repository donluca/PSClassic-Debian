...
- **You get an error everytime you try to mount a USB drive:** this is a goof on my part, I messed up the settings on the /media/psclassic/ folder where external mass storage devices are mounted. To fix this, open a terminal and type: sudo chown psclassic:pslassic /media/psclassic
